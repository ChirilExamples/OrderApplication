    ...
    Dialog(
        ...
        Card(
            ...
            Column(
                ...
                Column {
                    Text(
                        text = "Ordered from ${orderDetailListItem.delivererName}",
                        fontSize = 25.sp,
                    ...
                    LazyColumn(
                        ...
                        items(
                            ...
                            Row(
                                ...
                                Text(
                                    text = "%.2f"
                                        .format(it.pricePerAmount * it.selectedAmount) + " $"
                                )
                            }
                        }
                    }
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "%.2f".format(orderDetailListItem.products.sumOf { (it.selectedAmount*it.pricePerAmount).toDouble() }) + " $",
                            fontWeight = FontWeight.Bold
                        )
